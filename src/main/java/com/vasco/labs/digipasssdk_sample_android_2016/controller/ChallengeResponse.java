...
public class ChallengeResponse {
    ...
    public static Boolean generate(String challenge, String password,Context context){
         ...
         * generate a response
         */
        GenerationResponse generationResponse = DigipassSDK.generateResponseFromChallenge(staticVector, dynamicVector, challenge, password, timeShift, DigipassSDKConstants.CRYPTO_APPLICATION_INDEX_APP_2, digipassFingerprint);
        ...
        if(generationResponse.getReturnCode()==0){
            result= true;
            response = generationResponse.getResponse();
